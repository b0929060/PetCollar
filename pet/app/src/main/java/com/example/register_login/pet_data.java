...
public class pet_data extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pet_data);
        ...
        t1 = (TextView) findViewById(R.id.petname);
        t1.setText("名字");
        String jsonText = "";
        ...
        showJson(jsonText);
        Button btn2 = (Button) findViewById(R.id.backbtn3);

        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(pet_data.this, PetHomePage.class);
